...
eventTest = parallel $
    describe "event tests" $ do
      ...
      it "can decode simple storage" $
        ...
        in decodeEvent (changeTopics change) (changeData change) `shouldBe` Right (NewCount 10)
      ...
      it "can decode erc20" $
        ...
        in decodeEvent (changeTopics ercchange) (changeData ercchange) `shouldBe` Right (Transfer "0x0000000000000000000000000000000000000001" 10 "0x0000000000000000000000000000000000000002")
